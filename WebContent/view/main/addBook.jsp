	...
	<nav style="border-radius:0px;" class="navbar navbar-expand-sm bg-secondary navbar-dark">
		...
		<main>	
			<div style="margin-top:20px; height:550px;">
				<H4 style="text-align:center"><b>도서 추가</b></H4>
				<form style="margin-top:10px; margin-left:28.5%" ACTION="/main/addbook" METHOD="POST" class="form-horizontal">
				  <div class="form-group" style="width:95%">
				    <label class="col-sm-2 control-label">아이디</label>
				    <div class="col-sm-10" style="width:100%">
				      <input style="width:40%; align:center" type="text" class="form-control" name="id" placeholder="ID">
				    </div>
				  </div>
				  <div class="form-group" style="width:95%">
				    <label class="col-sm-2 control-label">제목</label>
				    <div class="col-sm-10" style="width:100%">
				      <input style="width:40%" type="text" class="form-control" name="name" placeholder="Title">
				    </div>
				  </div>
				  <div class="form-group" style="width:95%">
				    <label class="col-sm-2 control-label">저자</label>
				    <div class="col-sm-10" style="width:100%">
				      <input style="width:40%" type="text" class="form-control" name="writer" placeholder="Writer">
				    </div>
				  </div>
				  <div class="form-group" style="width:95%">
				    <label class="col-sm-2 control-label">가격</label>
				    <div class="col-sm-10" style="width:100%">
				      <input style="width:40%" type="text" class="form-control" name="cost" placeholder="Price">
				    </div>
				  </div>
				  <div class="form-group" style="width:95%">
				    <div class="col-sm-offset-2 col-sm-10" style="width:100%">
				      <button style="width:40%" type="submit" class="btn btn-secondary">저장</button>
				    </div>
				  </div>
				</form>
			</div>
